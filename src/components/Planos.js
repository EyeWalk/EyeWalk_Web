        ...
        <Container id='planos' className='p-md-0 p-lg-5 my-5 d-flex flex-column justify-content-center mh-100 align-items-center'>
            ...
            <Row className='justify-content-between' id='listaPlanos'>
                <Col xs='12' sm='12' md='6' lg='5' className='fs-3 text-center mt-5'>
                    {
                    planos
                        ? <PlanCard title={planos[0].name} text={planos[0].description} price={currencyFormat(planos[0].price)} imgSrc={imageApp} imgAlt='Aplicação Web' btnText='Assinar' href='/comprar?plano=basico'></PlanCard>
                ...
                <Col xs='12' sm='12' md='6' lg='5' className='fs-3 text-center mt-5'>
                    {
                    planos
                        ? <PlanCard title={planos[1].name} text={planos[1].description} price={currencyFormat(planos[1].price)} imgSrc={imageOculos} imgAlt='Óculos EyeWalk' btnText='Assinar' href='/comprar?plano=premium'></PlanCard>
